...
const MESSAGES = {
  en: {
    ...
    reveal_image_alt: "Celebration image",
    image_unavailable: "📷 Image unavailable",
    answer_locked: "✅ Answer locked: {answer}",
    time_expired: "⏱ Time expired for this question",
    answer_revealed_badge: "Answer revealed",
    correct_answer_label: "Correct answer: {answer}",
    answer_phase_closed: "Answer window closed for this question",
